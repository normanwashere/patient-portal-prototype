...
export const PATIENT_TENANT_MAP: Record<string, string> = {
  ...
  'p-mc18': 'maxicare', // Ricardo Mendoza (Emergency)
  'p-mc19': 'maxicare', // Baby Sofia Cruz (Emergency)
};
...
export const MOCK_STAFF: StaffUser[] = [
  ...
  // ── Additional Maxicare Specialty Doctors ──
  {
    id: 'staff-mc05',
    name: 'Dr. Miguel Tan',
    role: 'doctor',
    department: 'Pediatrics',
    specialty: 'Pediatrics',
    specializations: ['Pediatrics', 'Neonatology', 'General Practice'],
    branchId: BRANCH_MAIN,
    email: 'mtan@maxicare.ph',
    phone: '0917-333-0005',
    photoUrl: 'https://randomuser.me/api/portraits/men/44.jpg',
    credentials: ['MD', 'DPPS', 'Fellow - Philippine Pediatric Society'],
  ...
  },
  {
    ...
    branchId: BRANCH_MAIN,
    email: 'areyes@maxicare.ph',
    phone: '0917-333-0007',
    photoUrl: 'https://randomuser.me/api/portraits/men/46.jpg',
    credentials: ['MD', 'DPBO', 'Fellow - Philippine Orthopedic Association'],
  ...
  {
    id: 'staff-mc08',
    name: 'Dr. Isabella Navarro',
    role: 'doctor',
    department: 'Psychiatry',
    specialty: 'Psychiatry',
    specializations: ['Psychiatry', 'Addiction Medicine'],
    branchId: BRANCH_MAIN,
    email: 'inavarro@maxicare.ph',
    phone: '0917-333-0008',
    photoUrl: 'https://randomuser.me/api/portraits/women/47.jpg',
    credentials: ['MD', 'DPBP', 'Fellow - Philippine Psychiatric Association'],
  ...
  },
  {
    ...
    specializations: ['Endocrinology', 'Internal Medicine', 'Diabetes Management'],
    branchId: BRANCH_MAIN,
    email: 'cmendoza@maxicare.ph',
    phone: '0917-333-0009',
    photoUrl: 'https://randomuser.me/api/portraits/men/48.jpg',
    credentials: ['MD', 'FPCP', 'FPSEDM'],
...
export const MOCK_LAB_ORDERS: LabOrder[] = [
  ...
  // External orders — performed at partner facilities
  { id: 'lab-ext-mc01', patientId: 'p-mc1', patientName: 'Andrea Reyes', doctorId: 'staff-mc01', doctorName: 'Dr. Carmela Ong',
    testName: 'MRI - Brain with Contrast', testType: 'Imaging' as const, priority: 'Routine' as const, status: 'Resulted' as const,
    orderedDate: '2026-02-05', collectedDate: '2026-02-06', resultedDate: '2026-02-08',
    result: 'No acute intracranial abnormality. Mild chronic microvascular ischemic changes.',
    isExternal: true, externalFacility: 'Hi-Precision Diagnostics - Makati', externalPartnerFee: 12500, externalOrderRef: 'HP-2026-08841' },
  { id: 'lab-ext-mc02', patientId: 'p-mc2', patientName: 'Mark Anthony Lim', doctorId: 'staff-mc04', doctorName: 'Dr. Jen Diaz',
    testName: 'Holter Monitor (24-hour)', testType: 'Cardio' as const, priority: 'Routine' as const, status: 'Resulted' as const,
    orderedDate: '2026-02-01', collectedDate: '2026-02-03', resultedDate: '2026-02-05',
    result: 'Normal sinus rhythm. No significant arrhythmias detected. Rare PVCs (<1%).',
    isExternal: true, externalFacility: 'Philippine Heart Center', externalPartnerFee: 8500, externalOrderRef: 'PHC-26-0442' },
  { id: 'lab-ext-mc03', patientId: 'p-mc1', patientName: 'Andrea Reyes', doctorId: 'staff-mc02', doctorName: 'Dr. Ramon Bautista',
    testName: 'Bone Densitometry (DEXA Scan)', testType: 'Imaging' as const, priority: 'Routine' as const, status: 'Ordered' as const,
    orderedDate: '2026-02-11',
    isExternal: true, externalFacility: 'St. Lukes Medical Center - BGC', externalPartnerFee: 6800, externalOrderRef: 'SL-LAB-2026-1120' },
  { id: 'lab-ext-mc04', patientId: 'p-mc6', patientName: 'Roberto Lim', doctorId: 'staff-mc01', doctorName: 'Dr. Carmela Ong',
    testName: 'Tumor Markers Panel (CEA, AFP, CA19-9)', testType: 'Laboratory' as const, priority: 'Urgent' as const, status: 'In Progress' as const,
    orderedDate: '2026-02-10', collectedDate: '2026-02-11',
    isExternal: true, externalFacility: 'Quest Diagnostics Philippines', externalPartnerFee: 9200, externalOrderRef: 'QD-PH-8876' },
];
...
export const MOCK_QUEUE_PATIENTS: QueuePatient[] = [
  ...
  // Carlos: just arrived at Check-In (location verified via geofence)
  { ...qpBase('qp-003', 'p3', 'Carlos Reyes', 'T003', 'Check-In', 'QUEUED', '2026-02-12T09:00:00', 5, 'Normal', 'Annual physical'), locationVerified: true },
  // Ramon: PWD at Check-In (location verified via geofence)
  { ...qpBase('qp-009', 'pt-new-1', 'Ramon Ong', 'T009', 'Check-In', 'QUEUED', '2026-02-12T09:20:00', 0, 'PWD', 'New patient - BP check'), locationVerified: true },
  // Anna: READY at Triage (location verified)
  { ...qpBase('qp-004', 'p5', 'Anna Santos', 'T004', 'Triage', 'READY', '2026-02-12T08:15:00', 18, 'Normal', 'Daughter fever - Mia, 3yo', undefined, 'Nurse Paolo Mendoza', [], -1,
    [{ station: 'Check-In', enteredAt: '2026-02-12T08:00:00', exitedAt: '2026-02-12T08:08:00' }, { station: 'Triage', enteredAt: '2026-02-12T08:08:00' }]), locationVerified: true },
  ...
  // Juan: IN_SESSION at Consult Room 1 (Dr. Santos - Cardiology) — doctor is seeing him (location verified)
  { ...qpBase('qp-001', 'p1', 'Juan Dela Cruz', 'T001', 'Consult', 'IN_SESSION', '2026-02-12T08:30:00', 12, 'Normal', 'Follow-up chest tightness', 'Dr. Ricardo Santos', 'Nurse Elena Torres', [], -1,
    [{ station: 'Check-In', enteredAt: '2026-02-12T08:00:00', exitedAt: '2026-02-12T08:05:00' }, { station: 'Triage', enteredAt: '2026-02-12T08:05:00', exitedAt: '2026-02-12T08:18:00' }, { station: 'Consult', enteredAt: '2026-02-12T08:18:00' }], 'cr-1', 'Room 1'), locationVerified: true },
  ...
  // Emergency: Elderly man — severe abdominal pain
  qpBase('qp-mc14', 'p-mc18', 'Ricardo Mendoza', 'MC-014', 'Triage', 'READY', '2026-02-12T10:25:00', 2, 'Emergency', 'Severe abdominal pain, guarding, diaphoretic', undefined, undefined, [], -1,
    [{ station: 'Check-In', enteredAt: '2026-02-12T10:22:00', exitedAt: '2026-02-12T10:23:00' }, { station: 'Triage', enteredAt: '2026-02-12T10:23:00' }]),
  // Emergency: Child with febrile seizure
  qpBase('qp-mc15', 'p-mc19', 'Baby Sofia Cruz', 'MC-015', 'Consult', 'QUEUED', '2026-02-12T10:15:00', 6, 'Emergency', 'Febrile seizure — 2yo, T 39.8°C', 'Dr. Patricia Santos', undefined, [], -1,
    [{ station: 'Check-In', enteredAt: '2026-02-12T10:08:00', exitedAt: '2026-02-12T10:09:00' }, { station: 'Triage', enteredAt: '2026-02-12T10:09:00', exitedAt: '2026-02-12T10:12:00' }, { station: 'Consult', enteredAt: '2026-02-12T10:12:00' }], 'cr-mc3', 'Room C'),
...
export const MOCK_REFERRALS: PatientReferral[] = [
  // Metro General referrals
  {
    id: 'ref-001',
    patientId: 'p-self',
    patientName: 'Juan Dela Cruz',
    ...
    urgency: 'Routine',
    status: 'Completed',
    reason: 'Cardiac risk assessment — elevated BP readings at multiple visits with family history of premature CAD',
    clinicalSummary: 'Patient is a 45-year-old male with Stage 1 HTN (avg BP 145/92), on Losartan 50mg. Family history of MI (father at 52). Lipid panel shows borderline LDL 142 mg/dL. ECG normal. Requesting cardiac risk stratification and possible stress testing.',
    diagnosis: 'Essential Hypertension',
    icdCode: 'I10',
    attachedLabOrderIds: ['lab-001'],
    createdAt: '2026-01-20T09:30:00',
    acceptedAt: '2026-01-20T14:00:00',
    scheduledDate: '2026-01-28',
    completedAt: '2026-01-28T11:30:00',
    responseNotes: 'Cardiac workup completed. Treadmill stress test negative. ASCVD risk moderate (12%). Recommend continuing Losartan, add Aspirin 80mg daily, recheck lipids in 3 months.',
    tenantId: 'metroGeneral',
  },
  {
    id: 'ref-002',
    ...
    urgency: 'Routine',
    status: 'Scheduled',
    reason: 'Annual diabetic eye screening — patient on Metformin, last eye exam >1 year ago',
    clinicalSummary: 'T2DM with recent HbA1c 7.2%. No visual complaints currently. Requesting dilated fundoscopy for diabetic retinopathy screening.',
    diagnosis: 'Type 2 Diabetes Mellitus',
    icdCode: 'E11.9',
    createdAt: '2026-02-10T10:15:00',
    acceptedAt: '2026-02-10T16:00:00',
  ...
  },
  {
    ...
    referredToSpecialty: 'ENT',
    referredToFacility: 'Metro General Hospital - Main',
    type: 'Internal',
    urgency: 'Routine',
    status: 'Pending',
    reason: 'Recurrent otitis media — 4 episodes in 6 months, assess need for tympanostomy tubes',
    clinicalSummary: '8-year-old female with recurrent acute otitis media. 4 episodes since August 2025, last treated with Augmentin. Audiometry shows mild conductive hearing loss on right. Parents requesting ENT evaluation.',
    diagnosis: 'Recurrent Acute Otitis Media',
    icdCode: 'H66.91',
    createdAt: '2026-02-12T08:45:00',
    tenantId: 'metroGeneral',
  },
  {
    id: 'ref-004',
    ...
    referredToFacility: 'St. Lukes Medical Center - BGC',
    type: 'External',
    urgency: 'Urgent',
    status: 'Accepted',
    reason: 'Suspected thyroid nodule — palpable 2cm nodule on right lobe, needs FNA biopsy',
    clinicalSummary: 'Patient noted a palpable thyroid mass during routine physical exam. Ultrasound confirms a 2.1cm solid nodule on right thyroid lobe, ACR TI-RADS 4. TSH normal at 2.1 mIU/L. Requesting FNA biopsy and endocrine evaluation.',
    diagnosis: 'Thyroid Nodule',
    icdCode: 'E04.1',
    createdAt: '2026-02-11T14:00:00',
    acceptedAt: '2026-02-12T09:00:00',
    tenantId: 'metroGeneral',
  },
  // Maxicare referrals
  {
    ...
    patientId: 'p-mc1',
    patientName: 'Andrea Reyes',
    referringDoctorId: 'staff-mc01',
    referringDoctorName: 'Dr. Carmela Ong',
    referringSpecialty: 'Internal Medicine',
    referredToSpecialty: 'Cardiology',
    referredToDoctorId: 'staff-mc02',
    ...
    clinicalSummary: '32-year-old female, mild HTN on Losartan 50mg. Father had MI at 55. LDL 138 mg/dL. Requesting 2D echo and cardiac risk stratification.',
    diagnosis: 'Essential Hypertension',
    icdCode: 'I10',
    createdAt: '2026-01-15T10:00:00',
    acceptedAt: '2026-01-15T14:30:00',
    scheduledDate: '2026-01-22',
    completedAt: '2026-01-22T10:45:00',
    responseNotes: '2D echo normal. EF 65%. No structural abnormalities. Low-moderate ASCVD risk. Continue current medications. Annual follow-up recommended.',
    tenantId: 'maxicare',
  },
  {
    id: 'ref-mc02',
    ...
    clinicalSummary: 'Patient reports persistent work-related anxiety with insomnia for 3 months. GAD-7 score 12 (moderate). No suicidal ideation. Requesting psychiatric evaluation and CBT consideration.',
    diagnosis: 'Generalized Anxiety Disorder',
    icdCode: 'F41.1',
    createdAt: '2026-02-05T11:00:00',
    acceptedAt: '2026-02-06T09:30:00',
  ...
  },
  {
    ...
    clinicalSummary: '40-year-old male with 6-month history of progressive lower back pain radiating to left leg. Failed NSAIDs and physical therapy. MRI reveals L4-L5 posterolateral disc protrusion with mild neural foraminal narrowing. Requesting orthopedic evaluation for possible intervention.',
    diagnosis: 'Lumbar Disc Degeneration',
    icdCode: 'M51.16',
    createdAt: '2026-02-12T09:15:00',
    tenantId: 'maxicare',
  },
  {
    id: 'ref-mc04',
    patientId: 'p-mc3',
    patientName: 'Grace Lim',
    referringDoctorId: 'staff-mc03',
    referringDoctorName: 'Dr. Patricia Santos',
    referringSpecialty: 'OB-GYN',
    referredToSpecialty: 'Maternal-Fetal Medicine',
    referredToFacility: 'Asian Hospital and Medical Center',
    type: 'External',
    urgency: 'Urgent',
    status: 'Accepted',
    reason: 'High-risk pregnancy — gestational diabetes + advanced maternal age',
    clinicalSummary: '38-year-old G2P1 at 28 weeks AOG with gestational diabetes diagnosed at 24 weeks. Currently on insulin. OGTT markedly elevated. Requesting MFM co-management for optimized delivery planning.',
    diagnosis: 'Gestational Diabetes Mellitus',
    icdCode: 'O24.419',
    createdAt: '2026-02-08T13:30:00',
    acceptedAt: '2026-02-09T10:00:00',
    tenantId: 'maxicare',
  },
  {
    id: 'ref-mc05',
    ...
    urgency: 'Routine',
    status: 'Pending',
    reason: 'Declining eGFR — Stage 3a CKD in diabetic patient, needs nephrology co-management',
    clinicalSummary: '65-year-old male with T2DM x 15 years, HTN. Recent labs: Creatinine 1.6 mg/dL, eGFR 48 ml/min, UACR 85 mg/g. Requesting nephrology evaluation for CKD co-management and nephroprotection strategy.',
