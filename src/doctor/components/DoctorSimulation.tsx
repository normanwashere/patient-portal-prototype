...
export const DoctorSimulation: React.FC<Props> = ({ onClose }) => {
  ...
  const steps: SimStep[] = [
    ...
    },
    {
      ...
      route: '/doctor/queue',
      feature: 'QUEUE',
      featureColor: 'var(--color-success)',
      icon: <Users size={18} />,
    ...
    },
    {
      ...
      featureColor: 'var(--color-warning)',
      icon: <Pill size={18} />,
    ...
    },
    {
      ...
      route: '/doctor',
      feature: 'MODE SWITCH',
      featureColor: 'var(--color-purple-dark)',
      icon: <Video size={18} />,
    ...
    },
    {
      ...
      feature: 'LAB RESULTS',
      featureColor: 'var(--color-secondary)',
      icon: <ClipboardList size={18} />,
